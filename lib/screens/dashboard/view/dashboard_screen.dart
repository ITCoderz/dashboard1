                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            ? SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Spacer(),
                                    CustomDateField(
                                      textEditingController: dashboardController
                        ...
                        Wrap(
                          ...
                          children: [
                            for (int index = 0;
                                index < dashboardController.activityList.length;
                                index++) ...[
                              Obx(() {
                                return ActivityCheckCardWidget(
                                  activityModel:
                                      dashboardController.activityList[index],
                                  itemIndex: index,
                                  isDropped:
                                      dashboardController.droppedList[index],
                                  dropFunction: () {
                                    dashboardController.toggleActivityDropView(
                                      index: index,
                                  ...
                                  scrollController: index == 0
                                      ? dashboardController.toDoScrollController
                                      : index == 1
                                          ? dashboardController
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      width:
                                          constraint.maxWidth > 640 ? 500 : 370,
                                      padding: const EdgeInsets.symmetric(
                                        vertical: 15,
                                        horizontal: 20,
                                      ),
                                    ...
                                    BackgroundContainerWidget(
                                      ...
                                      widget: Column(
                                        ...
                                        children: [
                                          ...
                                          const Text(
                                            "Patient List",
                                            style: CustomTextStyles.white618,
                                          ),
                                          10.ph,
                                          const CustomHorizontalDivider(),
                                          Expanded(
                        ...
                        BackgroundContainerWidget(
                          ...
                          widget: SecondaryDataListTable(
                            allDataList: ConstantLists.secondaryTableDataList,
                          ),
                        ),
                      ],
                    ),
